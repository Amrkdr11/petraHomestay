                ...
                <div class="row ">
                    <div class="col-12  align-self-center">
                        <div class="sub-header mt-3 py-3 align-self-center d-sm-flex w-100 rounded">
                            <div class="w-sm-100 mr-auto"><h4 class="mb-0">Payments</h4></div>
                                        ...
                                        <tbody>
                                            ...
                                            ?>  
                                                <tr>
                                                    ...
                                                    <td>RM <?php echo $rows['amount']; ?></td>
                                                    <td><?php echo $rows['payment_method']; ?></td>
                                                    <td><?php echo $rows['payment_status']; ?></td>

                                                    <td>
                                                        <?php if ($rows['payment_status'] === 'Pending') : ?>
                                                            <a href="updatePayment.php?payment_id=<?php echo $rows['payment_id']; ?>" class="btn btn-success btn-sm">Done</a>
                                                        <?php else : ?>
