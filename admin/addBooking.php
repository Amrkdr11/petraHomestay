                ...
                <div class="col-12 col-lg-6 mt-3">
                    <div class="card">
                        <div class="card-header">                               
                            <h4 class="card-title">Booked date</h4>                                
                        </div>
                                ...
                                <div class="row">                                           
                                    ...
                                    <form action="bookingProcess.php" method="post">
                                            <div class="form-group row">
                                                <label for="username" class="col-sm-2 col-form-label">Customer</label>
                                                <div class="col-sm-10">
                                                <select name="user_id" class="form-control" id="userIdDropdown" onchange="calculateTotal()" required>
                                                    <option disabled selected value="">Select Customer</option>
                                                    <?php
                                                    // Query to fetch user_id and any additional fields you may need
