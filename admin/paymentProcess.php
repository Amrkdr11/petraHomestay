...
if (isset($_POST['addBooking'])) {
    ...
    $paymentMethod = isset($_POST['paymentMethod']) ? $_POST['paymentMethod'] : 'cash'; // Default to Bank if not selected
    $paymentDate = date('Y-m-d H:i:s');
    $paymentStatus = 'Pending'; // Set status based on payment method
